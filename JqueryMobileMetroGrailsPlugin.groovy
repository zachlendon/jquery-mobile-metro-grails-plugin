class JqueryMobileMetroGrailsPlugin {
    ...
    def title = "Plugin containing jQuery Mobile framework Metro UI theme resource files"
    def description = 'Plugin jQuery mobile framework Metro UI theme resource files.'
    ...
    def developers = [
            [ name: "Zach Lendon", email: "zach.lendon@gmail.com" ]]
}
